...
public class FileSyncServerService extends WatchDirectoryService implements Runnable {
    ...
    /**
     * Save the fileList hash table to disk.
     */
    public static void saveFileListHashtable() throws IOException {
        for (Map.Entry<String, FileListService> entry : fileListHashtable.entrySet()) {
            System.out.println("Save file list hashtable");
            String pathName = entry.getKey();
            FileListService fileList = entry.getValue();
            FileListXMLService.saveFileListToXML(fileList);
            System.out.println("Save filelist.xml of user: " + pathName + " filelist size: " + fileList.getFileHashTable().size());
        }
    }

    /**
     * Deprecated, synchronize to all servers and clients.
     */
    ...
    /**
     * Deprecated, synch with an online server. 
     * @param activeServer
    ...
    /**
     * Synchronize with a connected client. 
     * @param activeClient
     * @throws RemoteException
     * @throws JSchException
     * @throws SftpException
    ...
    /**
     * Upload a created file to a server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Download a whole directory from an online server.
     * @param directory
     * @param activeServer
     * @throws JSchException
     * @throws SftpException
     */
    public void downloadDirectoryFromServer(String sourceDir, String dstDir, ActiveServer activeServer) throws JSchException, SftpException {

        SFTPService sftpService = new SFTPService(activeServer.getServerIP());
        sftpService.downloadDirectory(sourceDir, dstDir, this.getDir().toString(), this.getDir().toString());
    }

    /**
     * Upload a modified file to a server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Upload a deleted file to a server.
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Update the fileInfo to a server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Sychronize a created file with server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Synchronize a modified file with a server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Synchronize a deleted file with a server. 
     * @param userName
     * @param directory
     * @param fileName
     * @param activeServer
    ...
    /**
     * Synchronize a created file with a client. 
     * @param directory
     * @param fileName
     * @param activeClient
     * @throws RemoteException
    ...
    /**
     * Synchronize a modified file with a client.
     * @param userName
     * @param directory
     * @param fileName
     * @param activeClient
    ...
    /**
     * Synchronize a deleted file with a client.
     * @param userName
     * @param directory
     * @param fileName
     * @param activeClient
    ...
    /**
     * Synchronize a created file with all connected servers and clients.
     * @param userName
     * @param directory
     * @param fileName
     * @throws JSchException
     ...
     * @throws SftpException
     */
    public void syncCreatedFile(String userName, String directory, String fileName) {
    ...
    /**
     * Synchronize a modified file with all connected servers and clients.
     * @param userName
     * @param directory
     * @param fileName
     * @throws JSchException
     ...
     * @throws SftpException
     */
    public void syncModifiedFile(String userName, String directory, String fileName) {
    ...
    /**
     * Synchronize a deleted file with all connected servers and clients.
     * @param userName
     * @param directory
     * @param fileName
     * @throws JSchException
     ...
     * @throws SftpException
     */
    public void syncDeletedFile(String userName, String directory, String fileName) {
